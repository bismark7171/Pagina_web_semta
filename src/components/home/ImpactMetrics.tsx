      ...
      <div className="mx-auto w-full max-w-container-semta px-gutter-desktop">
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          <div className="max-w-xl">
            ...
            <h2 className="mt-4 font-headline-xl text-on-surface">
              ...
              <span className="text-primary">territorio</span>
            </h2>
            <p className="mt-3 text-body-lg text-on-surface-variant">
              Datos auditados con cooperación internacional y sistematizados por
              nuestro equipo técnico junto a las comunidades.
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {impactMetrics.map((m) => (
            <article
              key={m.titulo}
              className="group rounded-3xl border border-outline-variant bg-surface-container-lowest p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-card-semta"
            >
