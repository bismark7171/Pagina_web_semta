        ...
        <div className="flex flex-col items-start justify-between gap-10 lg:flex-row lg:items-center">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 max-w-xl text-body-lg leading-relaxed text-white/85">
              Únete como voluntario, institución aliada o cooperante. Juntos
              llevamos agua, soberanía alimentaria y energías limpias a más
              familias originarias.
            </p>
          </div>

          <div className="shrink-0">
            <Button href="/contacto" variant="outline" size="lg" className="border-white bg-white/10 text-white hover:bg-white hover:text-verde-semta">
